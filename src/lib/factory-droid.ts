...
const DROID_MODELS_SCRIPT = "#!/usr/bin/env bun\n" + DROID_MODEL_LIB + [
  ...
  "console.log(\"JCE Droid Model Picker\");",
  "console.log(\"\");",
  ...
  "console.log(\"  /jce-agent-model <agent> <model|default>\");",
  "console.log(\"\");",
  "console.log(\"Examples:\");",
  "console.log(\"  /jce-agent-model jce-worker default\");",
  "for (const item of choices.filter((item) => item.modelForCommand !== \"default\").slice(0, 12)) console.log(\"  /jce-agent-model jce-worker \" + item.modelForCommand);",
  "console.log(\"\");",
